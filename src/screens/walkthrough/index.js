...
const WalkThrough = () => {
    ...
    return <View style={{backgroundColor: colors.background, flex: 1, flexDirection: 'row'}}>
        ...
        <View style={{ width: '85%', height: 200, position: 'absolute', left: 0, bottom: 0, backgroundColor: colors.primary, borderTopRightRadius: 100, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={{width: '70%', height: '70%'}}>
                ...
                <Text style={{ color: colors.white, padding: 5 }}>You have nothing to be scared about, we got you covered.</Text>
